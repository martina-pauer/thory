...
class Inventory():
    ...
    def save(self) -> str:
        ...
        self.load(f'CREATE TABLE {langs.traslations.traslate("inventory_items")} ({langs.traslations.traslate("Moment")} timestamp, {langs.traslations.traslate("Good_Name")} varchar(255), {langs.traslations.traslate("Available_Units")} int, {langs.traslations.traslate("Price")} DECIMAL(6, 2), {langs.traslations.traslate("Currency")} varchar(3), {langs.traslations.traslate("Total_ARS_Price")} DECIMAL(6, 2));\n')
